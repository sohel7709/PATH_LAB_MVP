  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-8 text-white">
        ...
        <p className="mt-2 text-lg opacity-90">Role: {user?.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Technician'}</p>
      </div>
      ...
      {/* Recent Patients */}
      <div className={`bg-white shadow-md rounded-lg overflow-hidden transition-all duration-500 ${animateElements ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      ...
      {/* Recent Reports */}
      <div className={`bg-white shadow-md rounded-lg overflow-hidden transition-all duration-500 delay-100 ${animateElements ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        <div className="px-6 py-5 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button 
                ...
                className={`p-1 rounded-full hover:bg-gray-200 transition-all duration-200 ${refreshing ? 'animate-spin' : ''}`}
                title="Refresh"
              >
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredReports.map((report) => (
                      <tr key={report.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-4 whitespace-nowrap text-sm">
                          <div className="flex space-x-2">
                            <Link to={`/reports/${report.id}/print`} className="text-blue-600 hover:text-blue-900" title="View Report">
